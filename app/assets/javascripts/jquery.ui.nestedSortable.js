	...
	$.widget("ui.nestedSortable", $.extend({}, $.ui.sortable.prototype, {
		...
		serialize: function(o) {
			...
			$(items).each(function() {
				...
				if(res) str.push((o.key || res[1]+'['+(o.key && o.expression ? res[1] : res[2])+']')+'='+(pid ? (o.key && o.expression ? pid[1] : pid[2]) : '1'));
			});
		...
		toArray: function(o) {
			...
			ret.push({"item_id": '1', "parent_id": 'none', "depth": sDepth, "left": '1', "right": ($('li', this.element).length + 1) * 2});
		...
		_isAllowed: function(parentItem, levels) {
			...
			var parentClass = $(this.currentItem).attr("id").replace(/[\d_]/g,"");
